    ...
    <div className={`max-w-7xl mx-auto w-full px-4 py-6 sm:px-6 lg:px-8 grid grid-cols-1 ${selectedGame === 'ketmesye' && activeTab === 'play' ? '' : 'lg:grid-cols-4'} gap-6 relative`}>
      ...
      <div className={`${selectedGame === 'ketmesye' && activeTab === 'play' ? 'lg:col-span-4' : 'lg:col-span-3'} flex flex-col space-y-6`}>
        ...
        <a 
          ...
          className="flex items-center justify-between p-3 sm:p-4 bg-gradient-to-r from-emerald-900/60 to-green-900/40 border border-emerald-500/30 rounded-2xl hover:bg-emerald-800/50 transition-colors group shadow-lg shadow-emerald-900/20"
        >
          <div className="flex items-center space-x-3 sm:space-x-4">
            <div className="h-10 w-10 sm:h-12 sm:w-12 bg-emerald-500/20 rounded-full flex items-center justify-center border border-emerald-500/40 group-hover:scale-110 transition-transform">
            ...
            <div>
              <h3 className="text-sm sm:text-base font-bold text-emerald-400 flex items-center gap-2">
                Abonne ak nou sou WhatsApp <Check className="w-4 h-4 bg-emerald-500 text-white rounded-full p-0.5" />
              </h3>
              <p className="text-xs sm:text-sm text-emerald-200/70">Pa rate okenn kado, kòd promo ak gwo anons ofisyèl yo !</p>
            </div>
          </div>
          <div className="hidden sm:flex items-center text-emerald-400 font-medium text-sm group-hover:translate-x-1 transition-transform">
            Rejwenn nou <ArrowUpRight className="ml-1 w-4 h-4" />
          </div>
        </a>

        {/* TikTok Channel Banner */}
        <a 
          href="https://www.tiktok.com/@ketarena?_r=1&_t=ZS-97C95JlKF0f" 
          target="_blank" 
          rel="noopener noreferrer"
          className="flex items-center justify-between p-3 sm:p-4 bg-gradient-to-r from-slate-900/60 to-slate-800/40 border border-slate-500/30 rounded-2xl hover:bg-slate-800/50 transition-colors group shadow-lg shadow-black/20"
        >
          <div className="flex items-center space-x-3 sm:space-x-4">
            <div className="h-10 w-10 sm:h-12 sm:w-12 bg-slate-800 rounded-full flex items-center justify-center border border-slate-500/40 group-hover:scale-110 transition-transform">
            ...
            <div>
              <h3 className="text-sm sm:text-base font-bold text-white flex items-center gap-2">
                Swiv nou sou TikTok <Check className="w-4 h-4 bg-blue-500 text-white rounded-full p-0.5" />
              </h3>
              <p className="text-xs sm:text-sm text-slate-300">Gade tout bèl video nou yo, epi genyen plis kado !</p>
            </div>
          </div>
          <div className="hidden sm:flex items-center text-white font-medium text-sm group-hover:translate-x-1 transition-transform">
            Swiv nou <ArrowUpRight className="ml-1 w-4 h-4" />
          </div>
        </a>
